...
function showFacs(num, url, id) {
	...
	facsWindow.document.write("<link rel='stylesheet' href='/assets/js/jquery-ui/themes/base/jquery.ui.all.css'>")
	facsWindow.document.write($('style')[0].outerHTML)
	facsWindow.document.write("<script type='text/javascript' src='/assets/js/jquery-ui/jquery-ui-1.10.3.min.js'></script>")
	facsWindow.document.write("<script type='text/javascript' src='/assets/js/jquery-ui/ui/jquery-ui.js'></script>")
	facsWindow.document.write("<script type='text/javascript' src='/assets/js/jquery/plugins/jquery.scrollTo-1.4.3.1-min.js'></script>")
