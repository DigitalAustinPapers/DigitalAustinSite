...
25*b+")"});d3.select(b.node().parentNode).style("height",g+30+30+"px");d.append("rect").attr("fill","red").attr("class","bar").attr("width",function(a){return e(a.weight)}).attr("height",19);d.append("text").attr("x",function(a){return e(a.weight-3)}).attr("y",10).attr("fill","black").attr("dy",".35em").text(function(a){return a.weight});b.append("g").attr("class","label-container").selectAll("text").data(a).enter().append("text").attr("class","label").attr("transform",function(a,b){return"translate(0,"+
25*b+")"}).attr("dy",".75em").text(function(a){return a.text}).attr("color","black")}var timeChart,timeChartNeedsUpdate=!0;google.load("visualization","1",{packages:["corechart"],callback:function(){timeChart=new google.visualization.ColumnChart(document.getElementById("timeChart"))}});
