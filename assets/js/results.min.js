...
a+="&toPlaceId=";a+=encodeURIComponent(document.getElementById("toPlaceId").value);a+="&sentiment=";a+=encodeURIComponent(document.getElementById("sentiment").value);a+="&sort=";a+=encodeURIComponent(sortKey);var b="";document.getElementById("query").value&&(b="text: <b>"+document.getElementById("query").value+"</b>");document.getElementById("fromYear").value&&(b+=" starting: <b>"+document.getElementById("fromYear").value+"</b>");document.getElementById("toYear").value&&(b+=" ending: <b>"+document.getElementById("toYear").value+
"</b>");if(document.getElementById("fromPersonId").value)var c=document.getElementById("fromPersonId").value,b=b+(" sender: <b>"+personIdToNames[c]+"</b>");document.getElementById("toPersonId").value&&(c=document.getElementById("toPersonId").value,b+=" recipient: <b>"+personIdToNames[c]+"</b>");document.getElementById("fromPlaceId").value&&(c=document.getElementById("fromPlaceId").value,b+=" sent from: <b>"+placeIdToNames[c]+"</b>");document.getElementById("toPlaceId").value&&(c=document.getElementById("toPlaceId").value,
b+=" sent to: <b>"+placeIdToNames[c]+"</b>");document.getElementById("sentiment").value&&(b+=" with <b>"+document.getElementById("sentiment").value+"</b> sentiment scores");""==b&&(b="all results.");document.getElementById("humanQuery").innerHTML=b;$.getJSON("search_results.php"+a,function(a){$(document).trigger("basicDataLoaded",[a])});$.getJSON("data/cloud.php"+a,function(a){$(document).trigger("chartDataLoaded",[a])});$.getJSON("data/cities.php"+a,function(a){$(document).trigger("cityDataLoaded",
...
$(document).on("basicDataLoaded",function(a,b){null!=b&&b!=basicData?(basicData=b,updateDocuments()):alert("?")});$("input:radio[name=sort]").on("click",function(a){sortKey=$("input:radio[name=sort]:checked").val();queryChanged()});
