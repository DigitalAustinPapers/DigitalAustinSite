...
$("input:radio[name=sort]").on("click",function(a){sortKey=$("input:radio[name=sort]:checked").val();queryChanged()});function updateSentiment(){$(".search-result-list__item-sentiment-score").each(function(){var a=$(this),c=a.attr("data-sentiment");c<negativeThreshold?a.addClass("sentiment-negative"):c>positiveThreshold?a.addClass("sentiment-positive"):a.addClass("sentiment-neutral")})}
