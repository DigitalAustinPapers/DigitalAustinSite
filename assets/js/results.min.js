...
$(document).on("basicDataLoaded",function(a,c){null!=c&&c!=basicData?(basicData=c,updateDocuments(),updateSentiment()):alert("?")});$("input:radio[name=sort]").on("click",function(a){sortKey=$("input:radio[name=sort]:checked").val();queryChanged()});
